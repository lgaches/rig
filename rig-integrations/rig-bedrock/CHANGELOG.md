...
## [Unreleased]
## [0.4.4](https://github.com/lgaches/rig/compare/rig-bedrock-v0.4.3...rig-bedrock-v0.4.4) - 2026-04-09

### Added

- *(rig-bedrock)* add OpenTelemetry tracing to completion model ([#1567](https://github.com/lgaches/rig/pull/1567)) (by @sachin-punyani)

### Other

- Add support for prompt caching in rig-bedrock ([#1584](https://github.com/lgaches/rig/pull/1584)) (by @marcbrooker) - #1584
